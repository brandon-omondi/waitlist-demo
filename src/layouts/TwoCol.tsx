...
export function TwoCol() {
    ...
    return(
        <div className="c-container flex flex-col md:flex-row gap-2 mt-2 md:h-[650px]">
            <div className="c-leftside w-full md:w-1/2 mt-10 mr-5 md:mr-0 ">
...
And now, you can become the very first user and get lifetime student discounts for free.</p>
            ...
            <div className="c-rightside w-full md:w-1/2 mb-20">
                <img className=" mt-2 px-10 pt-2 md:h-[600px] w-full md:w-[600px] shrink-0 motion-reduce:animate-bounce" src="https://i.postimg.cc/Hshr9XzC/twin.png" alt="" />
            </div>
        </div>
    )
}