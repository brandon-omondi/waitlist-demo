    ...
    return(
        <div className="c-container flex flex-col md:flex-row gap-2 mt-2 w-full md:h-[650px]">
            <div className="c-leftside w-1/2 mt-10">
                <div className="text-[28px] md:text-[56px] font-bold text-pretty">
                ...
                <p className="mt-4 w-[444px] text-white text-justify text-sm md:text-xl font-poppins font-normal leading-6 opacity-60">Our team has been working on an exciting product to make spending much cheaper for students, forever!
