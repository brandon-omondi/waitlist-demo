    ...
    return(
        <div className="c-container mt-20 mb-20  h-auto font-poppins text-white">
            ...
            <div className="c-why flex flex-col md:flex-row items-center mt-4 px-10 justify-center md:space-x-20 space-y-10 md:space-y-0">
                <div className="c-save bg-cards md:w-[420px] px-5 pt-3 pb-4 rounded-3xl text-justify">
                    <h3 className="font-semibold md:text-[28px] mb-3">Save money</h3>
                    <p className="text-left text-sm md:text-lg leading-6 mb-7 opacity-80">With studentribe every purchase is a saving. We’ve lobbied for exclusive student discounts from local retailers and restaurants</p>
                ...
                <div className="c-community bg-cards md:w-[420px] px-5 pt-3 pb-4 rounded-3xl text-justify">
                    <h3 className="font-semibold md:text-[28px] mb-3">Community</h3>
                    <p className="text-left text-sm md:text-lg leading-6 mb-7 opacity-80">We offer exciting opportunities for community building through music concerts, networking mixers and many more.</p>
