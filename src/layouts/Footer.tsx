...
export function Footer() {
    return(
        ...
        <h1 className=" text-white text-center md:text-2xl font-bold leading-8 mt-8">We are just starting this journey, <br/> it’d be cool if you tagged along!</h1>
        ...
        <h3 className="self-stretch text-white text-center md:text-xl font-normal leading-6 opacity-40 mt-7 mb-4">© 2024 All Rights Reserved. StudenTribe, Ltd</h3>
        </div>
    )
}